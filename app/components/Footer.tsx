        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-6 sm:gap-8 mb-6 sm:mb-8">
          ...
          <div>
            ...
            <p className="text-sm sm:text-base text-gray-400 mb-3 sm:mb-4 leading-relaxed">
              Your trusted partner in finding the right healthcare professionals. 
              Connect with verified doctors and take control of your health.
            </p>
          ...
          <div>
            ...
            <ul className="space-y-2 sm:space-y-3">
              ...
              <li>
                <Link href="/specialties" className="hover:text-blue-400 transition-colors">
                  Specialties
                </Link>
              </li>
              <li>
          ...
          <div>
            ...
            <ul className="space-y-2 sm:space-y-3">
              ...
              <li className="flex items-start gap-3">
                ...
                <span>support@doctorfind.com</span>
              </li>
              <li className="flex items-start gap-3">
                <svg className="w-5 h-5 text-blue-400 mt-1 flex-shrink-0" fill="none" stroke="currentColor" viewBox="0 0 24 24">
        ...
        <div className="border-t border-gray-800 pt-6 sm:pt-8 mt-6 sm:mt-8">
          <div className="flex flex-col sm:flex-row justify-between items-center gap-3 sm:gap-4">
            <p className="text-gray-400 text-xs sm:text-sm text-center sm:text-left">
              © {new Date().getFullYear()} DoctorFind. All rights reserved.
            </p>
