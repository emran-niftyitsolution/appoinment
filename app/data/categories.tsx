...
export const categories: MedicalCategory[] = [
  ...
  {
    name: "Pathology",
    description: "Disease diagnosis and lab testing",
    icon: () => (
      <svg
        className="w-10 h-10"
        fill="none"
  ...
  {
    name: "Geriatrics",
    description: "Elderly care and aging health",
    icon: () => (
      <svg
        className="w-10 h-10"
        fill="none"
  ...
  },
  {
    ...
    description: "Bacterial and viral infections",
    icon: () => (
      <svg
        className="w-10 h-10"
        fill="none"
  ...
  },
  {
    ...
    description: "Heart surgery and procedures",
    icon: () => (
      <svg
        className="w-10 h-10"
        fill="none"
