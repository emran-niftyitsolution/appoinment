...
import { specialties, locations } from '../data/filters'
...
export default function DoctorsPage() {
  ...
  const [selectedSpecialty, setSelectedSpecialty] = useState(categoryFromUrl || 'All Specialties')
          ...
          <div className="flex flex-col sm:flex-row sm:items-center sm:justify-between gap-4 sm:gap-6 mb-6 sm:mb-8">
            <div className="max-w-3xl">
              <div className="inline-flex items-center gap-1.5 sm:gap-2 px-3 sm:px-4 py-1.5 sm:py-2 bg-blue-100/50 backdrop-blur-sm rounded-full mb-4 sm:mb-6 border border-blue-200/50">
                ...
                <span className="text-xs sm:text-sm font-semibold text-blue-700">Verified Healthcare Professionals</span>
              </div>
              ...
              <p className="text-base sm:text-lg md:text-xl lg:text-2xl text-gray-600 leading-relaxed">
                Browse through our extensive network of trusted healthcare professionals. 
                Book appointments, get consultations, and take control of your health.
              </p>
            </div>
        ...
        <div className="flex gap-4 sm:gap-6 lg:gap-8">
          ...
          `}>
            <div className="p-6 lg:p-8">
              ...
              {/* Active Filters */}
              {(selectedSpecialty !== 'All Specialties' || selectedLocation !== 'All Locations' || searchQuery) && (
          ...
          <div className="flex-1 min-w-0">
            ...
            <div className="mb-8 flex flex-col sm:flex-row items-start sm:items-center justify-between gap-4 p-6 bg-white/60 backdrop-blur-xl rounded-2xl border border-gray-200/50 shadow-lg">
              <div>
                <p className="text-gray-600 mb-1">
                  Showing <span className="font-bold text-gray-900 text-lg">{filteredDoctors.length}</span> doctor{filteredDoctors.length !== 1 ? 's' : ''}
                  {selectedSpecialty !== 'All Specialties' && (
                    <span> in <span className="font-bold text-blue-600">{selectedSpecialty}</span></span>
                  )}
                </p>
                {filteredDoctors.length > 0 && (
                  <p className="text-sm text-gray-500">All verified and ready to help</p>
                )}
              </div>
              {filteredDoctors.length > 0 && (
                <div className="flex items-center gap-2 px-4 py-2 bg-gradient-to-r from-blue-50 to-cyan-50 rounded-xl border border-blue-200/50">
                  ...
                  <span className="text-sm font-semibold text-blue-700">Verified Professionals</span>
                </div>
              )}
            </div>
            ...
            {filteredDoctors.length > 0 ? (
              ...
              <div className="text-center py-24 bg-white/60 backdrop-blur-xl rounded-3xl border border-gray-200/50 shadow-xl">
                ...
                <h3 className="text-3xl font-bold text-gray-900 mb-3">No doctors found</h3>
                <p className="text-lg text-gray-600 mb-8 max-w-md mx-auto">
                  We couldn&apos;t find any doctors matching your criteria. Try adjusting your filters to see more results.
                </p>
                <button
                  onClick={() => {
                    setSelectedSpecialty('All Specialties')
